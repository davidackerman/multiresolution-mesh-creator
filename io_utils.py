...
class TemporaryNamedPipe:
    ...
    class Stream:
        ...
        def fileno(self, *args, **
                   kwargs): return self._file.fileno(*args, **kwargs)

        def flush(self, *args, **kwargs): return self._file.flush(*args, **kwargs)

        def isatty(self, *args, **
                   kwargs): return self._file.isatty(*args, **kwargs)

        def readable(self, *args, **
                     kwargs): return self._file.readable(*args, **kwargs)

        def readline(self, *args, **
                     kwargs): return self._file.readline(*args, **kwargs)
        def readlines(
            self, *args, **kwargs): return self._file.readlines(*args, **kwargs)
        ...
        def truncate(self, *args, **
                     kwargs): return self._file.truncate(*args, **kwargs)
        def writable(self, *args, **
                     kwargs): return self._file.writable(*args, **kwargs)

        def read(self, *args, **kwargs): return self._file.read(*args, **kwargs)

        def readall(self, *args, **
                    kwargs): return self._file.readall(*args, **kwargs)
        def readinto(self, *args, **
                     kwargs): return self._file.readinto(*args, **kwargs)
